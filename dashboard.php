<?php
ini_set('display_errors', 0); // Hide errors on the browser
ini_set('log_errors', 1);    // Enable error logging
ini_set('error_log', 'C:\xampp\php\php-error.log'); // Set log file path
error_reporting(E_ALL);     // Report all types of errors

session_start();
error_log("Debug: Started execution");
 include 'conn.php';
 include 'number_fomt.php';
 include 'strength.php';
 error_log("Debug: Included files");
...
<body class="theme-red">
        ...
        <div class="row clearfix" id="not">
            <div class="footer-basic" id="bot">
                <footer>
                    ...
                    <div class="social"><a href="https://www.instagram.com/amirghafoor786/"><i class="icon ion-social-instagram"></i></a><a href="#"><i class="icon ion-social-skype"></i></a><a href="https://twitter.com/"><i class="icon ion-social-twitter"></i></a><a href="https://web.facebook.com/amirghafoor.chaudhry/"><i class="icon ion-social-facebook"></i></a></div>
    ...
    <?php echo "<!-- Debug: Reached end of file -->"; ?>
</body>
